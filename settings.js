...
global.owner = process.env.OWNER_NUMBER  || '923087598338' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=LRFWQBAb#gj2cJDP0g3jkRCISLQAg2jkVDUQOP691OAbL13V31cY ' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "923087598338,923087598338" : process.env.MODERATORS ,    
